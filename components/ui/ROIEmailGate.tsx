    ...
    <div className="space-y-4">
      ...
      <div className="bg-white border border-[#E2E8F0] rounded-2xl p-6 flex items-center gap-5 shadow-sm">
        ...
        <div>
          ...
          <div className="text-[#64748B] text-sm">récupérées par mois</div>
        </div>
      </div>

      {/* Blurred results + gate */}
      <div className="relative bg-white border border-[#7C3AED]/30 rounded-2xl p-8 shadow-lg shadow-[#7C3AED]/10 overflow-hidden">
        ...
        <div className="absolute inset-0 p-8 select-none pointer-events-none" aria-hidden="true">
          <div className="space-y-6 blur-md opacity-50">
            <div>
              ...
              <div className="text-[#64748B] text-sm">économisés par mois</div>
            </div>
            <div>
              <div className="text-3xl font-extrabold text-[#7C3AED]">{formatEuro(savedMoneyPerYear)}</div>
              <div className="text-[#64748B] text-sm">économisés par an</div>
            </div>
          </div>
        </div>
        ...
        <div className="relative z-10">
          <div className="text-center mb-6">
            <div className="inline-flex items-center gap-2 bg-[#7C3AED]/8 rounded-full px-4 py-1.5 mb-4">
            ...
            <h3 className="text-lg font-extrabold text-[#0F0F1A] mb-2">
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            <input
              ...
              className="w-full border border-[#E2E8F0] rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-[#7C3AED] focus:ring-2 focus:ring-[#7C3AED]/20 transition-all"
            />
            <input
              type="text"
